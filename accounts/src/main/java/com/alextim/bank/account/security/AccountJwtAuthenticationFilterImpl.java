package com.alextim.bank.account.security;
...
import com.alextim.bank.common.security.JwtAuthenticationFilter;
...
@Slf4j
public class AccountJwtAuthenticationFilterImpl extends OncePerRequestFilter implements JwtAuthenticationFilter {
    ...
    private String refreshAccessTokenIfExpiring(HttpServletResponse response,
        ...
        TokenPairResponse tokenPair = authService.refreshToken(new RefreshRequest(refreshToken));
